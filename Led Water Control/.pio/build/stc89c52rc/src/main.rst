      ...
      000003 02 00 6B         [24]  347 	ljmp	_main
                                    ...
                                    357 ;------------------------------------------------------------
                                    358 ;	src\main.c:24: void delay(u16 i)
                                    359 ;	-----------------------------------------
                                    360 ;	 function delay
                                    361 ;	-----------------------------------------
      000062                        362 _delay:
      ...
      000064 AF 83            [24]  372 	mov	r7,dph
                                    373 ;	src\main.c:26: while(i);	
      000066                        374 00101$:
      000066 EE               [12]  375 	mov	a,r6
      000067 4F               [12]  376 	orl	a,r7
      000068 70 FC            [24]  377 	jnz	00101$
                                    378 ;	src\main.c:27: }
      00006A 22               [24]  379 	ret
                                    380 ;------------------------------------------------------------
                                    381 ;Allocation info for local variables in function 'main'
                                    382 ;------------------------------------------------------------
                                    383 ;i                         Allocated to registers r7 
                                    384 ;------------------------------------------------------------
                                    385 ;	src\main.c:35: void main()
                                    386 ;	-----------------------------------------
                                    387 ;	 function main
                                    388 ;	-----------------------------------------
      00006B                        389 _main:
                                    390 ;	src\main.c:38: led=~0x01;
      00006B 75 A0 FE         [24]  391 	mov	_P2,#0xfe
                                    392 ;	src\main.c:39: delay(50000); //��Լ��ʱ450ms	
      00006E 90 C3 50         [24]  393 	mov	dptr,#0xc350
      000071 12 00 62         [24]  394 	lcall	_delay
                                    395 ;	src\main.c:42: for(i=0;i<8;i++)
      000074                        396 00109$:
      000074 7F 00            [12]  397 	mov	r7,#0x00
      000076                        398 00105$:
                                    399 ;	src\main.c:44: P2=~(0x01<<i);	 //��1����iλ��Ȼ�󽫽����ֵ��P2��
      000076 8F 06            [24]  400 	mov	ar6,r7
      000078 8E F0            [24]  401 	mov	b,r6
      00007A 05 F0            [12]  402 	inc	b
      00007C 74 01            [12]  403 	mov	a,#0x01
      00007E 80 02            [24]  404 	sjmp	00124$
      000080                        405 00122$:
      000080 25 E0            [12]  406 	add	a,acc
      000082                        407 00124$:
      000082 D5 F0 FB         [24]  408 	djnz	b,00122$
      000085 F4               [12]  409 	cpl	a
      000086 F5 A0            [12]  410 	mov	_P2,a
                                    411 ;	src\main.c:45: delay(50000); //��Լ��ʱ450ms
      000088 90 C3 50         [24]  412 	mov	dptr,#0xc350
      00008B C0 07            [24]  413 	push	ar7
      00008D 12 00 62         [24]  414 	lcall	_delay
      000090 D0 07            [24]  415 	pop	ar7
                                    416 ;	src\main.c:42: for(i=0;i<8;i++)
      000092 0F               [12]  417 	inc	r7
      000093 BF 08 00         [24]  418 	cjne	r7,#0x08,00125$
      000096                        419 00125$:
      000096 40 DE            [24]  420 	jc	00105$
                                    421 ;	src\main.c:61: }
      000098 80 DA            [24]  422 	sjmp	00109$
                                    423 	.area CSEG    (CODE)
                                    424 	.area CONST   (CODE)
                                    425 	.area XINIT   (CODE)
